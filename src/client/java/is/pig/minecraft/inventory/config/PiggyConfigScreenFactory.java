                ...
                return YetAnotherConfigLib.createBuilder()
                                ...
                                .category(ConfigCategory.createBuilder()
                                                ...
                                                .group(OptionGroup.createBuilder()
                                                                .name(Component.literal("Sorting Burst Controller (AIMD)"))
                                                                .option(Option.<Integer>createBuilder()
                                                                                .name(Component.literal("Initial Burst Window"))
                                                                                .description(OptionDescription.of(Component.literal("Initial number of items to move in a single batch. Higher = Faster start.")))
                                                                                .binding(100, config::getAimdInitialWindow, config::setAimdInitialWindow)
                                                                                .controller(opt -> IntegerSliderControllerBuilder.create(opt).range(10, 200).step(10))
                                                                                .build())
                                                                .option(Option.<Integer>createBuilder()
                                                                                .name(Component.literal("Maximum Burst Window"))
                                                                                .description(OptionDescription.of(Component.literal("Maximum batch size. The window grows towards this as long as no lag is detected.")))
                                                                                .binding(500, config::getAimdMaxWindow, config::setAimdMaxWindow)
                                                                                .controller(opt -> IntegerSliderControllerBuilder.create(opt).range(100, 1000).step(50))
                                                                                .build())
                                                                .option(Option.<Integer>createBuilder()
                                                                                .name(Component.literal("Burst Increase Step"))
                                                                                .description(OptionDescription.of(Component.literal("How much the window grows after each successful batch. Adaptive scaling will reduce this if lag is detected.")))
                                                                                .binding(10, config::getAimdIncreaseStep, config::setAimdIncreaseStep)
