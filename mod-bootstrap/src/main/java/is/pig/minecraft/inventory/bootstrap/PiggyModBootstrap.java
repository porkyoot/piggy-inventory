package is.pig.minecraft.inventory.bootstrap;

import net.fabricmc.api.ModInitializer;
import net.fabricmc.loader.api.FabricLoader;
import is.pig.minecraft.inventory.api.IModAdapter;
import is.pig.minecraft.inventory.common.PiggyCore;
...
public class PiggyModBootstrap implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        if (selectedAdapter != null) {
            ...
            System.err.println("piggy-inventory: Failed to find suitable ModAdapter for version " + version);
        }
    }
